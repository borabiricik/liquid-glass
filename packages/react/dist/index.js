...
const LiquidGlass = ({ borderRadius = 20, blur = 0.25, contrast = 1.2, brightness = 1.05, saturation = 1.1, shadowIntensity = 0.25, displacementScale = 1, elasticity = 0.6, zIndex = 9999, className, children, }) => {
    ...
    const feDisplacementMapRef = react.useRef(null);
    ...
    const canvasDPI = 1;
    // Utility functions
    const smoothStep = react.useCallback((a, b, t) => {
        t = Math.max(0, Math.min(1, (t - a) / (b - a)));
        return t * t * (3 - 2 * t);
    }, []);
    const length = react.useCallback((x, y) => {
        return Math.sqrt(x * x + y * y);
    }, []);
    const roundedRectSDF = react.useCallback((x, y, w, h, radius) => {
    ...
    return (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [jsxRuntime.jsx("svg", { ref: svgRef, xmlns: "http://www.w3.org/2000/svg", width: "0", height: "0", style: {
                    position: "fixed",
                    top: 0,
                    left: 0,
                    pointerEvents: "none",
                    zIndex: zIndex - 1,
                }, children: jsxRuntime.jsx("defs", { children: jsxRuntime.jsxs("filter", { id: `${id}_filter`, filterUnits: "userSpaceOnUse", colorInterpolationFilters: "sRGB", x: "0", y: "0", width: width.toString(), height: height.toString(), children: [jsxRuntime.jsx("feImage", { ref: feImageRef, id: `${id}_map`, width: width.toString(), height: height.toString() }), jsxRuntime.jsx("feDisplacementMap", { ref: feDisplacementMapRef, in: "SourceGraphic", in2: `${id}_map`, xChannelSelector: "R", yChannelSelector: "G" })] }) }) }), jsxRuntime.jsx("canvas", { ref: canvasRef, width: width * canvasDPI, height: height * canvasDPI, style: { display: "none" } }), jsxRuntime.jsx("div", { ref: containerRef, className: className, style: {
                    position: "relative",
                    width: "100%",
                    height: "100%",
                    overflow: "hidden",
